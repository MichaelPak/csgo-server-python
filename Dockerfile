...
RUN dpkg --add-architecture i386 \
    ...
    && apt-get -y update \
    && apt-get -y install lib32gcc1 wget net-tools lib32stdc++6 zlib1g:i386 libffi6:i386 python3.6 python3-pip=9.0.1-2 \
...
RUN pip3 install --user -t $SERVER/csgo/csgo/addons/source-python/packages/custom/ -r $HOME/requirements.txt
